...
type LayoutMode = 'layout-piles' | 'layout-scatter' | 'layout-cairn';
    ...
    const calculateStones = useCallback((): StoneData[] => {
        ...
        return sortedEntries.map((entry, index) => {
            ...
            if (layoutMode === 'layout-scatter') {
                // Scatter view: random X, Y based on recency
                size = 20 + (intensityFactor * 60) + (recency * 30);
                ...
                blur = recency < 0.5 ? (1 - recency) * 4 : 0;
                ...
                size = 100 + (intensityFactor * 100) - (recency * 50);
